            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <form action="<?= base_url('perbarui_gejala/' . $data['id']); ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php if (session('errors.deskripsi')) : ?>is-invalid<?php endif ?>" id="" placeholder="Enter Deskripsi" name="deskripsi" value="<?= old('deskripsi', $data['deskripsi']); ?>">
                                    <div class="invalid-feedback">
